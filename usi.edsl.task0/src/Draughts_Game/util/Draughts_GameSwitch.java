 ...
 * @generated
 */
public class Draughts_GameSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Draughts_GamePackage.DRAUGHTS: {
				Draughts draughts = (Draughts)theEObject;
				T result = caseDraughts(draughts);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Draughts_GamePackage.MAN: {
				Man man = (Man)theEObject;
				T result = caseMan(man);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Draughts_GamePackage.KING: {
				King king = (King)theEObject;
				T result = caseKing(king);
				if (result == null) result = caseMan(king);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Draughts_GamePackage.LOCATION: {
				Location location = (Location)theEObject;
				T result = caseLocation(location);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Draughts_GamePackage.BOARD: {
				Board board = (Board)theEObject;
				T result = caseBoard(board);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Draughts_GamePackage.SQUARE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Draughts</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Draughts</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDraughts(Draughts object) {
		return null;
	}
