...
/**
 * This is the item provider adapter for a {@link Draughts_Game.Location} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Location_row_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Location_row_feature", "_UI_Location_type"),
				 Draughts_GamePackage.Literals.LOCATION__ROW,
				 true,
				 false,
				 false,
	...
	protected void addColumnPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Location_column_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Location_column_feature", "_UI_Location_type"),
				 Draughts_GamePackage.Literals.LOCATION__COLUMN,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		ROW labelValue = ((Location)object).getRow();
